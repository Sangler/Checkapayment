...
import { t as getFeeItems } from "./fees-D0BkK9q3.mjs";
import { n as require_jsx_runtime, r as require_react } from "../_libs/react+tanstack__react-query.mjs";
import { h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { _ as Check, c as Mail, f as Gift, m as Copy, o as Phone, r as ShieldCheck, u as LoaderCircle, v as ArrowUpRight, x as Activity } from "../_libs/lucide-react.mjs";
import { n as useSession, t as AppShell } from "./AppShell-DYuFWkQ_.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/dashboard-CweFp8sq.js
...
function DashboardPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppShell, {
		...
		children: [
			...
			!guest && kycStatus !== "approved" && kycStatus !== "verified" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mb-10 flex flex-wrap items-center justify-between gap-4 rounded-md border border-primary/30 bg-primary/5 px-4 py-3",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "font-mono text-xs text-primary",
					children: "Your profile is incomplete — finish KYB to unlock full account limits."
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					to: "/collect-info",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mb-8 rounded-xl border border-border bg-card/40 p-8 text-center",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
