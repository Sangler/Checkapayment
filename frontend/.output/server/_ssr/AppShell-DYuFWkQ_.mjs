...
import { a as Search, b as ArrowLeftRight, h as CircleUserRound, i as Settings, l as LogOut, n as User, p as FilePlusCorner, s as Menu } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/AppShell-DYuFWkQ_.js
...
function isProfileComplete(user) {
	...
	if (!user.emailVerified || !user.phoneVerified || !user.dateOfBirth) return false;
	const address = user.address ?? {};
	const hasAddress = REQUIRED_ADDRESS_FIELDS.every((field) => Boolean(address[field]));
	if (user.isBusinessAccount) return Boolean(user.jobTitle && user.businessName && user.businessType) && hasAddress;
...
function AppShell({ user, guest = false, searchValue, onSearchChange, children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		}), !guest ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CompleteProfileModal, { user }) : null]
	});
}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
				className: "flex flex-1 flex-col space-y-1 px-3 py-4",
				...
				}, to)), !guest ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					type: "button",
					onClick: handleLogout,
					disabled: signingOut,
					title: "Log out",
					className: `mt-auto flex items-center gap-3 rounded-md border border-transparent px-3 py-2.5 text-sm font-medium text-muted-foreground transition-colors hover:border-border hover:bg-accent/50 hover:text-destructive disabled:opacity-60 ${collapsed ? "justify-center" : "justify-center md:justify-start"}`,
...
function CompleteProfileModal({ user }) {
	const navigate = useNavigate();
	...
	if (!user || complete || dismissed) return null;
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: [
						...
						" ",
						user.isBusinessAccount ? "your business info" : "your employment info",
						" — before you can send or receive payments."
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
