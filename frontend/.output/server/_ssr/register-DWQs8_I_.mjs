...
import { _ as useNavigate, g as require_react_dom, h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/register-DWQs8_I_.js
	...
	const validateForm = () => {
		...
		if (formData.accountType === "business") {
			...
			if ([
				...
				setStatus({
					type: "error",
					message: "Business accounts must use a company email address, not a personal email provider."
				});
				return false;
			}
		}
